...
//use port 8070 for this example
...
//use port 8090 for this example
...
http.createServer(function (req, res) {
  if (req.url == '/fileupload') {
    ...
    form.parse(req, function (err, fields, files) {
      ...
      var newpath = '/Users/noam/JS/NodeJS/Projects/NodeJSprojects/program9/' + files.filetoupload.name;
...
//use port 8080 for this example